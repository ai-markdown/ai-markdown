...
| `autoDetectUnknownLanguage` | `boolean`               | `true`                              | Identify an unannotated block's language with `@ai-markdown/code-language-detector`, synchronously during render (server rendering included). A block the detector abstains on stays plaintext labelled "unknown"; the detector never overrides an explicit fence language                                                                                                                                                                                                                             |
