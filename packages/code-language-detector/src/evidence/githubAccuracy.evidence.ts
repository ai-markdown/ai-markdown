...
import { corpusFiles, corpusLanguages, corpusRoot, pct, print, quantile, readCorpusText } from './corpus';

// Fixed-seed pseudo-random snippet lengths, so runs are comparable
let seed = 20260916;
const rand = () => {
...
it('one-shot accuracy on the GitHub corpus', () => {
