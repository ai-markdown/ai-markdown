    ...
    const pipeline = useMemo(
      () =>
        pipelineSession.parse({
          ...
          // includes remark-gfm and remark-math, so the scanner may release
          // proven task boxes from the reference taint, including boxes
          // whose paragraph a `$$` opener closed.
