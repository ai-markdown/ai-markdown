...
| `codeBlock.autoDetectUnknownLanguage` | `boolean`               | `false`       | Detect the language of unlabelled blocks with `@ai-markdown/code-language-detector`; a block the detector abstains on stays plaintext labelled "unknown"                                                                                                                                                          |
...
- The package and version (`@ai-markdown/react@3.2.1` …)
